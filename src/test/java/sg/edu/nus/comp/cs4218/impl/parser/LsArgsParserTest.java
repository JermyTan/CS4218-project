...
import sg.edu.nus.comp.cs4218.testutil.*;
...
class LsArgsParserTest {
    ...
    private static final char FLAG_IS_FOLDERS = 'd';
    private static final char FLAG_IS_SORT_BY_EXT = 'X';
    private static final String VALID_OPTION_1 = String.format("%s%s", CHAR_FLAG_PREFIX, FLAG_IS_RECURSIVE);
    private static final String VALID_OPTION_2 = String.format("%s%s", CHAR_FLAG_PREFIX, multiplyChar(FLAG_IS_FOLDERS, 3));
    private static final String VALID_OPTION_3 = String.format("%s%s%s%s", CHAR_FLAG_PREFIX, FLAG_IS_FOLDERS, FLAG_IS_RECURSIVE, FLAG_IS_SORT_BY_EXT);
    private static final String INVALID_OPTION_1 = multiplyChar(CHAR_FLAG_PREFIX, 2);
    private static final String INVALID_OPTION_2 = String.format("%s%s%s", CHAR_FLAG_PREFIX, FLAG_IS_RECURSIVE, CHAR_FLAG_PREFIX);
    private static final String INVALID_OPTION_3 = String.format("%s%s%s", CHAR_FLAG_PREFIX, FLAG_IS_FOLDERS, FLAG_IS_SORT_BY_EXT + 1);
